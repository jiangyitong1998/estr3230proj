...
train_smiles10 = falses[0:1200]
train_labels10 = a[0:1200]
train_smiles20 = falses[937:2000]
train_labels20 = a[937:2000]
train_smiles30 = falses[1847:2950]
train_labels30 = a[1847:2950]
train_smiles40 = falses[2811:3850]
train_labels40 = a[2811:3850]
train_smiles50 = falses[3748:4750]
train_labels50 = a[3748:4750]
train_smiles60 = falses[4685:5800]
train_labels60 = a[4685:5800]
train_smiles70 = falses[5622:6759]
train_labels70 = a[5622:6759]
    ...
    for j in range(7):
        ...
        #print(test_smile[:265].shape, test_lable[:265].shape)
            if i % 50 == 0:
                ...
                accur =  compute_accuracy(test_smile[:265], test_lable[:265])
                print(accur)
                if  accur >= 0.66:
                 if accur > big:
                  big = accur
